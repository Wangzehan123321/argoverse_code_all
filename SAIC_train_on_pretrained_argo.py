...
from SAIC_utils_new import SAICDataset,maskedMSE
...
class Visualizer(object):
    ...
    def txt(self,name,text,**kwargs):
        ...
        self.index[name]=x+1
vis=Visualizer('SAIC_lstm_on_pretrain_argo_nosuccess')
...
trSet = SAICDataset('SAIC/pkl_file/train_update_nosuccess.pkl')#train datatset
valSet = SAICDataset('SAIC/pkl_file/val_update_nosuccess.pkl')#val dataset
...
for epoch_num in range(trainEpochs):
    ...
    torch.save(net.state_dict(), './SAIC/trained_models/SAIC_lstm_on_pretrain_argo_nosuccess/cslstm_{}.tar'.format(str(epoch_num)))
