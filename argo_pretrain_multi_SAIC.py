...
from SAIC_utils import ArgoverseDataset,MSE,MSElastdistance,ADE_sequence
...
class Visualizer(object):
    ...
    def txt(self,name,text,**kwargs):
        ...
        self.index[name]=x+1
vis=Visualizer('argo_lstm_multi_ade_pretrain_SAIC')
...
trSet = ArgoverseDataset('../data/forecasting_features_train.pkl',social_input=args["social_input"])#train datatset
valSet = ArgoverseDataset('../data/forecasting_features_val.pkl',social_input=args["social_input"])#val dataset
...
for epoch_num in range(trainEpochs):
    ...
    torch.save(net.state_dict(), './SAIC/trained_models/argo_lstm_multi_ade_pretrain_SAIC/cslstm_{}.tar'.format(str(epoch_num)))
