...
from SAIC_utils import ArgoverseDataset,MSE,NLL
...
class Visualizer(object):
    ...
    def txt(self,name,text,**kwargs):
        ...
        self.index[name]=x+1
vis=Visualizer('argo_lstm_relative_absolute')
...
trSet = ArgoverseDataset('../data/forecasting_features_train.pkl',absolute=True,social_input=args["social_input"],vehicle_input=args["vehicle_input"])#train datatset
valSet = ArgoverseDataset('../data/forecasting_features_val.pkl',absolute=True,social_input=args["social_input"],vehicle_input=args["vehicle_input"])#val dataset
...
for epoch_num in range(trainEpochs):
    ...
    torch.save(net.state_dict(), './SAIC/trained_models/argo_lstm_relative_absolute/cslstm_{}.tar'.format(str(epoch_num)))
