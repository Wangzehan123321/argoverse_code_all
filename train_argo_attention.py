import torch
import numpy as np
from model_argo_attention import SAICNet,init_weights
from Argo_road_utils import ArgoverseDataset,MSE
...
class Visualizer(object):
    ...
    def txt(self,name,text,**kwargs):
        ...
        self.index[name]=x+1
vis=Visualizer('argo_attention_concat')
...
for epoch_num in range(trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        if args['use_maneuvers']:
            ...
            fut_pred= net(hist_traj_batch,hist_v=hist_v_batch,road_feature=road_feature_batch)
    ...
    torch.save(net.state_dict(), './SAIC/trained_models/argo_attention_concat/cslstm_{}.tar'.format(str(epoch_num)))
