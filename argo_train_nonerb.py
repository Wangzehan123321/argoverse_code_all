...
trSet = ArgoverseDataset('../data/data_nerb/forecasting_features_val.pkl',interaction=False)#train datatset
valSet = ArgoverseDataset('../data/data_nerb/forecasting_features_val.pkl',interaction=False)#val dataset
...
for epoch_num in range(trainEpochs):
    ...
    for i, data in enumerate(trDataloader):
        ...
        if args['use_maneuvers']:
            ...
            fut_pred = net(hist=hist_traj_batch)
